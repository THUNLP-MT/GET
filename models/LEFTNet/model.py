...
class LEFTNet(torch.nn.Module):
    ...
    def forward(self, batch_data):
        ...
        # # embed z
        # z_emb = self.z_emb(z)
        z_emb = z # already pass in embedded features
        ...
        # drop edges that is out of the distance cutoff
        select_edge_mask = dist < self.cutoff
        edge_index = edge_index.T[select_edge_mask].T
        i, j = edge_index
        dist = dist[select_edge_mask]
